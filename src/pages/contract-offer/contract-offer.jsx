...
import './contract-offer.scss';

export const ContractOffer = () => (
  <section className='contract-offer-page'>
    <div className='contract-offer-content'>
    <div className='menu-navigation'>
        <MenuNavigation />
        </div>
      <div className='content'>
        <h2 className='title'>Договор оферты</h2>
        <ol className='contract-offer-list'>
          <li className='contract-offer-item'>
